import './AnimatedGenerateButton.css'
...
export default function AnimatedGenerateButton({
  ...
  return (
    <div className={`ui-anim-btn-wrap ${className}`} id={id}>
      <button
        type={type}
      ...
      >
        ...
        <div className="ui-anim-txt-wrapper">
          <div className={`ui-anim-txt-1 ${generating ? 'active' : 'idle'}`}>
          ...
          <div className={`ui-anim-txt-2 ${generating ? 'active' : 'idle'}`}>
