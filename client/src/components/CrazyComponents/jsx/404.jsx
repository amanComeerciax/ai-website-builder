...
// --- Component Export ---
export default function Canyon404({
    title = "Not Found",
        ...
        <div className="relative w-full min-h-screen bg-[#111827] flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="relative z-[2] text-center mb-4 px-4">
                ...
                <p className="text-[#6b7280] font-medium tracking-[0.05rem]">
                    You can <Link to="/" className="text-[#06b6d4] hover:border-b-2 hover:border-[#06b6d4] transition-all">{homeText}</Link>, or <span className="text-[#06b6d4] cursor-pointer hover:border-b-2 hover:border-[#06b6d4] transition-all">{searchText}</span>.
                </p>
            </div>
            ...
            {/* Global/Component Styles for Fonts */}
