  ...
  },
  {
    ...
    matcher: (str) => {
      ...
      const ALLOWED = new Set([
        ...
        // Radix UI primitives (all commonly used ones)
        '@radix-ui/react-dialog', '@radix-ui/react-tooltip', '@radix-ui/react-accordion',
        '@radix-ui/react-slot', '@radix-ui/react-select', '@radix-ui/react-tabs',
        ...
        '@radix-ui/react-avatar', '@radix-ui/react-progress', '@radix-ui/react-scroll-area',
        '@radix-ui/react-navigation-menu', '@radix-ui/react-toggle', '@radix-ui/react-toggle-group',
        '@radix-ui/react-radio-group', '@radix-ui/react-slider', '@radix-ui/react-toast',
        '@radix-ui/react-alert-dialog', '@radix-ui/react-hover-card', '@radix-ui/react-context-menu',
        '@radix-ui/react-menubar', '@radix-ui/react-collapsible', '@radix-ui/react-aspect-ratio',
        // Common utility packages the AI may use
        'recharts', 'date-fns', 'sonner', 'cmdk', 'embla-carousel-react',
      ]);
